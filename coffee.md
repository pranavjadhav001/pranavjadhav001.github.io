...
<div class="page">
  ...
  <section class="field-notes">
    <details class="note-tab">
      ...
      <div class="note-body">
        ...
        <p>After a month of borrowing a V60 setup from a friend, I caved and bought a <strong>Hario V60</strong> for myself. This marked the beginning of my deep dive into <strong>the pourover rabbit hole.</strong> There were suddenly so many variables to tweak: water temperature, grind size, roast profile, brewing recipe, even the type of water 🌚!</p>
        <p>I also started appreciating the importance of <strong>coffee processing methods</strong> (washed, natural, etc.). The same beans could taste wildly different depending on how they were processed.</p>
    ...
    <details class="note-tab">
      <summary>Coffees to try</summary>
      <div class="note-body">
        <ul>
          ...
          <li><a href="https://marcscoffees.com/product/our-coffees/single-estates/balmaadi/">Marc&rsquo;s Balmaadi</a></li>
  ...
  <p class="closing-note">Blessed with friends who bring me coffee whenever they travel across India or Overseas 🥰</p>
